...
public class SwipeToDeleteCallback extends ItemTouchHelper.SimpleCallback {
    ...
    private final ProductOrdersAdapter adapter;
    private final OrderProductInterface listener;

    public SwipeToDeleteCallback(ProductOrdersAdapter adapter, OrderProductInterface listener) {
